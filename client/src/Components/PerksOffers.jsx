    ...
    <div className="py-4 flex justify-between xs:justify-normal xs:gap-[100px] sm:gap-[200px]">
      <div className="flex flex-col gap-4">
        <div className="flex gap-4">
          ...
          <span className={!perks.includes('wifi') &&"line-through"}>Wifi</span>
        </div>
        <div className="flex gap-4">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span className={!perks.includes('parking') &&"line-through"}>Free Parking Spot</span>
        </div>
        <div className="flex gap-4">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span className={!perks.includes('pets') &&"line-through"}>Pets</span>
        </div>
      </div>
      <div className="flex flex-col gap-4">
        <div className="flex gap-4">
          ...
          <span className={!perks.includes('tv') &&"line-through"}>TV</span>
        </div>
        <div className="flex gap-4">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span className={!perks.includes('radio') &&"line-through"}>Radio</span>
        </div>
        <div className="flex gap-4">
          <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span className={!perks.includes('private') &&"line-through"} >Private Entrance</span>
        </div>
      </div>
    </div>
  );
