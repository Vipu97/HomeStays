...
const Perks = ({perks,setPerks}) => {
  const handleCbClick = (e) => {
    ...
    checked ? setPerks([...perks,name]) : setPerks([...perks.filter(item => item !== name)])
  }
  return (
    <div className="grid gap-2 grid-cols-2 md:grid-cols-4 lg:grid -cols-6 mt-2 mb-3">
    <label className="border p-4 gap-2 rounded-2xl items-center cursor-pointer flex">
    ...
    <label className="border p-4 flex gap-2 rounded-2xl items-center cursor-pointer ">
      <input type="checkbox" onChange={handleCbClick} name='private'/>
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" class="w-5 h-5">
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15m3 0l3-3m0 0l-3-3m3 3H9" />
      </svg>
      <span>PrivateEntrance</span>
    </label>
  </div>
  )
}
