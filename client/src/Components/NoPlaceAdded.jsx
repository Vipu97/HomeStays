...
const NoPlaceAdded = () => {
    return (
        <div className="flex flex-col justify-center items-center gap-2 w-full max-w-[450px] mx-auto px-4">
            <div className="flex flex-col justify-start">
                <h1 className="my-6 text-3xl font-semibold">My Places</h1>
                <hr className="border border-gray-300" />
                <h3 className="pt-6 text-2xl font-semibold">No places added... yet!</h3>
